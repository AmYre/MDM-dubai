...
export default function Home() {
	...
	return (
		<>
			<Head>
				<link rel="alternate" hrefLang="ar-ae" href="https://marc-maison-antiques.ae/dubai" />
			</Head>
				...
				<section className="w-full flex justify-center">
					<div className="max-w-[1280px]">
						...
						<div className="flex justify-center mt-8">
							<Link href="https://www.marcmaison.com/" className="bg-primary px-4 py-2 hover:text-white hover:text-bold hover:scale-105 transition-all duration-300">
						...
						<div className="flex flex-col gap-6 mt-8 uppercase text-center font-georgia">
							<div className="flex flex-wrap justify-center items-center gap-6">
								<Link href="https://www.marcmaison.com/antique-lightings-lamps-chandelier" className="glass">
									...
									<p>{locales["light"][lang]}</p>
								</Link>
								<Link href="https://www.marcmaison.com/Fireplace-Mantels" className="glass">
									<Image src="/fire.png" className="" alt="Fireplace Mantels" width={250} height={250} />
									<p>{locales["fire"][lang]}</p>
								</Link>
								<Link href="https://www.marcmaison.com/objets-d-art-19th-century-paintings-and-furniture" className="glass">
									<Image src="/mantels.png" className="" alt="19th century paintings furniture and art objects" width={250} height={250} />
									<p>{locales["mantels"][lang]}</p>
								</Link>
							</div>
							<div className="flex flex-wrap justify-center items-center gap-6">
								<Link href="https://www.marcmaison.com/19th-century-french-furniture" className="glass">
									<Image src="/furn.png" className="" alt="19th century french furniture" width={250} height={250} />
									<p>{locales["furn"][lang]}</p>
								</Link>
								...
								<Link href="https://www.marcmaison.com/Architectural-Exterior" className="glass">
									<Image src="/ext.png" className="" alt="Architectural Exterior" width={250} height={250} />
									<p>{locales["ext"][lang]}</p>
								</Link>
							</div>
							<div className="flex flex-wrap justify-center items-center gap-6">
								<Link href="https://www.marcmaison.com/Fireplace-Accessories" className="glass">
									<Image src="/access.png" className="" alt="Fireplace Accessories" width={250} height={250} />
									<p>{locales["access"][lang]}</p>
								</Link>
								<Link href="https://www.marcmaison.com/visite-virtuelle" className="glass">
									<Image src="/tour.png" className="" alt="visite virtuelle" width={250} height={250} />
									<p>{locales["tour"][lang]}</p>
								</Link>
								<Link href="https://www.marcmaison.com/Interior-Decoration" className="glass">
									<Image src="/int.png" className="" alt="Interior Decoration" width={250} height={250} />
									<p>{locales["int"][lang]}</p>
								</Link>
							</div>
						</div>
					</div>
